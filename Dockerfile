...
COPY --chown=solar:solar config.py models.py veritabani.py collector.py collector_async.py panel.py auth.py notifications.py utils.py anomaly.py sanal_inverter.py styles.py healthcheck.py api.py prometheus_exporter.py mqtt_listener.py ./
