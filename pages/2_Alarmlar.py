...
section_header("", "Canli Alarm Paneli", "Cihazlardan gelen hata kodlarinin (Register 189 & 193) detayli dokumu")
...
if not durumlar:
    ...
    for row in durumlar:
        ...
        if has_error:
            ...
            if hatalar_189:
                parts.append('<div style="margin:8px 0 4px 0; font-weight:600; color:#f87171; font-family:Inter,sans-serif;">Register 189 Hatalari:</div>')
            ...
            if hatalar_193:
                parts.append('<div style="margin:8px 0 4px 0; font-weight:600; color:#f87171; font-family:Inter,sans-serif;">Register 193 Hatalari:</div>')
