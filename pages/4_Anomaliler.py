...
if anomaliler:
    ...
    kpi_row([
        ...
        {"value": str(uyari), "label": "Uyari", "color": "#f59e0b"},
    ])
    ...
    st.markdown('<div class="glossy-card" style="text-align:center;"><div style="font-size:2rem;margin-bottom:8px;"></div><div style="font-size:1rem;color:#94a3b8;font-family:Inter,sans-serif;">Anomali kaydi yok.</div></div>', unsafe_allow_html=True)
